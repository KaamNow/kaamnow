        ...
        >
          ...
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 18, marginBottom: 6 }}>
            ...
            <TouchableOpacity
              onPress={generateBio}
              disabled={genBio}
              style={{ flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "#eef2ff", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 5 }}
            >
              {genBio
...
const s = StyleSheet.create({
  ...
  editBtn:     { flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderColor: colors.primary, borderRadius: radius.pill, paddingHorizontal: 14, paddingVertical: 7 },
  editBtnText: { fontFamily: fonts.bodyBold, fontSize: 13, color: colors.primary },

  saveBtn:     { backgroundColor: colors.primary, borderRadius: radius.pill, paddingHorizontal: 18, paddingVertical: 8 },
  saveBtnText: { fontFamily: fonts.bodyBold, fontSize: 14, color: colors.onPrimary },

  // Read-only rows
  row:           { paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: colors.borderSubtle },
  rowLabel:      { fontFamily: fonts.bodyBold, fontSize: 11, color: colors.outline, letterSpacing: 0.8, marginBottom: 4 },
  ...
  rowValueEmpty: { color: colors.outline, fontFamily: fonts.body },

  // Edit inputs
  label:    { fontFamily: fonts.bodyBold, fontSize: 13, color: colors.textBody, marginBottom: 6, marginTop: 18 },
  hint:     { fontFamily: fonts.body, fontSize: 12, color: colors.outline, marginTop: 4 },
  ...
  readOnlyText:   { fontFamily: fonts.body, fontSize: 15, color: colors.outline },
  inputMultiline: { minHeight: 110, paddingTop: 13 },
  charCount:      { fontFamily: fonts.body, fontSize: 12, color: colors.outline, textAlign: "right", marginTop: 4 },

  genderRow:            { flexDirection: "row", gap: spacing.sm },
  genderChip:           { flex: 1, paddingVertical: 11, alignItems: "center", backgroundColor: colors.surfaceCard, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.borderSubtle },
  genderChipActive:     { backgroundColor: colors.primary, borderColor: colors.primary },
  genderChipText:       { fontFamily: fonts.bodyMedium, fontSize: 14, color: colors.textHeading },
