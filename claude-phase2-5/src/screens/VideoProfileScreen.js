...
const styles = StyleSheet.create({
  ...
  btn:        { backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: spacing.xl, paddingVertical: 16, minHeight: 52, alignItems: "center", justifyContent: "center" },
