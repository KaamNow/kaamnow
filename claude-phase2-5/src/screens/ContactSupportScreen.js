      ...
      >
        ...
        {SUPPORT_ITEMS.map((item) => (
          <Pressable
            ...
            onPress={item.action}
          >
            <View style={[styles.iconCircle, { backgroundColor: item.color === "#25D366" ? "#E7F8EE" : colors.surface }]}>
...
const styles = StyleSheet.create({
  ...
  userChipTxt: { fontFamily: fonts.bodySemi, fontSize: 12, color: colors.secondary },
