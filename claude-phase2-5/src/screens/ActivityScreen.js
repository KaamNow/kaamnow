...
const S = StyleSheet.create({
  ...
  progressMetaText: { fontFamily: fonts.body, fontSize: 17, color: colors.textSecondary, includeFontPadding: false },
  ...
  progressLocationText: { flex: 1, fontFamily: fonts.body, fontSize: 20, lineHeight: 28, color: colors.textSecondary },
  progressPriceBlock: { alignItems: "flex-end", flexShrink: 0, maxWidth: 128 },
  progressPrice: { fontFamily: fonts.bodyBold, fontSize: 29, lineHeight: 34, color: colors.textHeading, includeFontPadding: false },
  progressPriceUnit: { marginTop: 8, fontFamily: fonts.bodyBold, fontSize: 16, color: colors.textSecondary },
  progressDivider: { height: 1, backgroundColor: colors.borderSubtle, marginVertical: 34 },
  progressDateText: { flex: 1, fontFamily: fonts.body, fontSize: 20, lineHeight: 28, color: colors.textSecondary },
