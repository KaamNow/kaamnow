...
const S = StyleSheet.create({
  ...
  headerBack:  { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" },
  ...
  labelChip: {
    ...
    borderRadius: 20, borderWidth: 1.5, borderColor: colors.borderSubtle,
