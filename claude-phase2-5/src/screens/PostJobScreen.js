...
function getRateInsight(skill, rate) {
  ...
  if (rate > hi) return { tone: "success", color: colors.success, msg: `Above market (₹${lo}–₹${hi}/day). You'll attract experts faster.` };
  return { tone: "good", color: colors.success, msg: `Great rate. Market average ₹${lo}–₹${hi}/day.` };
}
        ...
        <View style={S.successSteps}>
          {[
            ...
            <View key={i} style={S.successStep}>
              <Ionicons name={step.icon} size={20} color={colors.success} />
              ...
              <View style={S.sectionCard}>
                ...
                {form.pincode.length === 6 && (
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 6, marginTop: 8 }}>
                    ...
                    <Text style={{ fontFamily: fonts.bodySemi, fontSize: 13, color: pinStatus === "loading" ? colors.outline : colors.success }}>
                      {pinStatus === "loading"
                        ? "Looking up area…"
                        : pinResult?.name
...
const S = StyleSheet.create({
  ...
  /* Progress */
  progressArea: { paddingHorizontal: 20, paddingTop: 16, paddingBottom: 4, backgroundColor: colors.bg },
  ...
  /* Scroll */
  scroll: { paddingHorizontal: 20, paddingTop: 28, paddingBottom: 120, backgroundColor: colors.bg },
  ...
  successCircle: { width: 96, height: 96, borderRadius: 48, backgroundColor: colors.success, alignItems: "center", justifyContent: "center", marginBottom: 24 },
  successTitle: { fontFamily: fonts.bodyBold, fontSize: 30, color: colors.textHeading, textAlign: "center", marginBottom: 10 },
  successSub: { fontFamily: fonts.body, fontSize: 16, color: colors.textSecondary, textAlign: "center", lineHeight: 24, marginBottom: 32 },
  successSteps: { width: "100%", gap: 14, marginBottom: 36 },
  successStep: { flexDirection: "row", alignItems: "center", gap: 12 },
  successStepText: { fontFamily: fonts.body, fontSize: 15, color: colors.textSecondary, flex: 1 },
  successBtn: { width: "100%", height: 52, borderRadius: 14, backgroundColor: colors.textHeading, alignItems: "center", justifyContent: "center", marginBottom: 12 },
  ...
  successBtnSecondaryText: { fontFamily: fonts.bodyBold, fontSize: 16, color: colors.textSecondary },
  ...
  catCard: { width: "48%", aspectRatio: 1, backgroundColor: "#ffffff", borderRadius: 24, borderWidth: 1, borderColor: colors.surface, alignItems: "center", justifyContent: "center", paddingVertical: 20, paddingHorizontal: 12, gap: 12, ...shadow.xs },
  ...
  requiredText:    { fontFamily: fonts.bodyBold, fontSize: 9, color: colors.danger, letterSpacing: 0.8 },
  ...
  counterBtn: { width: 56, height: 56, alignItems: "center", justifyContent: "center", backgroundColor: colors.surface },
  ...
  marketBadgeText: { fontFamily: fonts.bodyBold, fontSize: 12, color: colors.success },

  /* Rate input */
  rateInputRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  ratePrefix: { width: 44, height: 50, borderRadius: 12, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#e8e8ed" },
  ...
  optionCard: { flex: 1, paddingVertical: 12, paddingHorizontal: 8, borderRadius: 14, borderWidth: 1.5, borderColor: "#e8e8ed", backgroundColor: colors.bg, alignItems: "center" },
  ...
  segment: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5, paddingVertical: 12, borderRadius: 12, borderWidth: 1.5, borderColor: "#e8e8ed", backgroundColor: colors.bg },
  ...
  savedAddrChip:       { flexDirection: "row", alignItems: "center", gap: 7, marginHorizontal: 4, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, borderWidth: 1.5, borderColor: "#e8e8ed", backgroundColor: colors.bg, minWidth: 90 },
  ...
  savedAddrAddChip:    { flexDirection: "row", alignItems: "center", gap: 5, marginHorizontal: 4, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, borderWidth: 1.5, borderColor: "#e8e8ed", borderStyle: "dashed", backgroundColor: colors.bg },
  savedAddrAddText:    { fontFamily: fonts.bodySemi, fontSize: 12, color: colors.primary },
  saveAddrPrompt:      { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 10, alignSelf: "flex-start", paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: "#e8e8ed", backgroundColor: colors.bg },
  ...
  addrDefaultText: { fontFamily: fonts.bodyBold, fontSize: 9, color: colors.success, letterSpacing: 0.5 },
  addrAddLink: {
  ...
  anonIconWrap: { width: 44, height: 44, borderRadius: 12, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" },
  ...
  /* Step 4 — Hero */
  reviewHero: { backgroundColor: "#ffffff", borderRadius: 24, borderWidth: 1, borderColor: colors.surface, marginBottom: 14, overflow: "hidden", ...shadow.sm },
  ...
  reviewHeroBadge: { alignSelf: "flex-start", marginTop: 8, paddingHorizontal: 12, paddingVertical: 5, backgroundColor: colors.surface, borderRadius: 20 },
  ...
  reviewRowIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" },
  ...
  reviewDivider:  { height: 1, backgroundColor: colors.surface, marginVertical: 10 },
