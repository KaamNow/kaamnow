      ...
      >
        ...
        <View style={{ padding: spacing.lg }}>
          ...
          <View style={s.calCard}>
            ...
            <View style={s.legend}>
              {[
                { color: colors.success, en: "Accepted", hi: "मिला" },
                { color: colors.warning, en: "Pending",  hi: "बाकी" },
                { color: colors.success, en: "Completed", hi: "पूरा" },
                { color: colors.textMuted, en: "Cancelled", hi: "रद्द" },
              ].map(l => (
...
const s = StyleSheet.create({
  ...
  // Hero gradient
  hero: { backgroundColor: colors.primary, padding: spacing.xl, paddingTop: spacing.lg, paddingBottom: spacing.xl, position: "relative", overflow: "hidden" },
  heroCircle: { position: "absolute", width: 200, height: 200, borderRadius: 100, backgroundColor: "rgba(255,255,255,0.05)", top: -50, right: -50 },
  heroTitle: { fontFamily: fonts.bodyBold, fontSize: 22, color: colors.onPrimary, marginBottom: 4, letterSpacing: -0.3 },
  heroSub: { fontFamily: fonts.bodyBold, fontSize: 11, color: "rgba(255,255,255,0.7)", marginBottom: 20, textTransform: "uppercase", letterSpacing: 1 },
  heroStats: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.1)", borderRadius: radius.lg, paddingVertical: 14, paddingHorizontal: 10 },
  ...
  navBtn: { padding: 8, borderRadius: radius.md, backgroundColor: colors.surface, minWidth: 40, minHeight: 40, alignItems: "center", justifyContent: "center" },
  ...
  emptyDayText: { fontFamily: fonts.body, color: colors.textMuted, fontSize: 14 },
