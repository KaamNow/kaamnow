...
const styles = StyleSheet.create({
  ...
  avatarInitial: { color: colors.onPrimary, fontSize: 52, fontFamily: fonts.bodyBold },
  btn:           { backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: 28, paddingVertical: 16, minHeight: 52, alignItems: "center", justifyContent: "center" },
